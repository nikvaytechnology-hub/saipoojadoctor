...
public class StaticContent {
    ...
    public  class DrawerItem
    {
        ...
        public static final String MY_ACCOUNT = "My Profile";
        public static final String APPOINTMENT = " My Appointment";
        public static final String MY_PATIENT = " My Patient";
    ...
    public class IntentValue {
        ...
        public static final String ACTIVITY_CLASS_DETAILS = "Class Details";
