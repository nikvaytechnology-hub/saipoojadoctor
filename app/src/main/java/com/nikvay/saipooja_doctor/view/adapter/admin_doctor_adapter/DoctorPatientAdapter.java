...
import com.nikvay.saipooja_doctor.view.activity.doctor_activity.AppointmentHistoryActivity;
import com.nikvay.saipooja_doctor.view.activity.doctor_activity.PatientDetailsActivity;
import com.nikvay.saipooja_doctor.view.activity.doctor_activity.PatientDocumentListActivity;
import com.nikvay.saipooja_doctor.view.activity.doctor_activity.PaymentHistoryActivity;

import java.util.ArrayList;

public class DoctorPatientAdapter extends RecyclerView.Adapter<DoctorPatientAdapter.MyViewHolder> implements Filterable {
    private Context mContext;
    private ArrayList<PatientModel> patientModelArrayList;
    private ArrayList<PatientModel> arrayListFiltered;

    public DoctorPatientAdapter(Context mContext, ArrayList<PatientModel> patientModelArrayList) {
    ...
    @NonNull
    @Override
    public DoctorPatientAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_patient_adapter, parent, false);
        return new DoctorPatientAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DoctorPatientAdapter.MyViewHolder holder, final int position) {
