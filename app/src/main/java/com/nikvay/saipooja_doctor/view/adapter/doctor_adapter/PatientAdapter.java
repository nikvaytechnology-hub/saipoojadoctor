...
import com.nikvay.saipooja_doctor.view.activity.doctor_activity.NewAppointmentActivity;
...
public class PatientAdapter extends RecyclerView.Adapter<PatientAdapter.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        final String patient_id = patientModel.getPatient_id();
        ...
        holder.textPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra(StaticContent.IntentKey.PATIENT_DETAIL, patient_id);
                mContext.startActivity(intent);
            }
        });
