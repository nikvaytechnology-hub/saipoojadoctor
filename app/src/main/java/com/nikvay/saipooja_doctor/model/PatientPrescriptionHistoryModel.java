...
public class PatientPrescriptionHistoryModel {


    private String prescription_id,prescription_num,medication_name,medication_note,test_name,test_note,diagnosis,symptoms,photo,date,service_id,s_name,service_cost,description,name,patient_id;
